...
public class Datum implements Comparable<Datum> {
	...
	/**
	 * Maakt een datum object aan op basis van een string. Format: DD/MM/YYYY of DD-MM-YYYY of in MySQL notatie
	 * YYYY-MM-DD of 'YYYY-MM-DD'
	 *
	 * @param datum
	 *            de String met een datum waarde (DD/MM/YYYY of DD-MM-YYYY) de String met een MySQL datum waarde
	 *            (YYYY-MM-DD of 'YYYY-MM-DD')
	 * @throws IllegalArgumentException
	...
	/**
	 * Geeft een niet-afgebakende string in MySQL formaat ("YYYY-MM-DD") Te gebruiken voor vb. MySQL datum notatie
	 * 
